...
int sx1509Setup(const int pinBase, const int i2cAddress, const int resetPin, const int interruptPin, const int oscillatorPin)
{
    int fd;
    ...
    node->data0           = 0;
    node->data1           = resetPin;
    node->data2           = interruptPin;
    node->data3           = oscillatorPin;
